...
export function parseProps<T extends Record<string, any>>(props: T, ownProps: string[]) {
    ...
    (acc, [propKey, propValue]) => {
      if (ownProps.includes(propKey)) {
        ...
        if (typeof propValue === 'object' && propValue !== null) {
          Object.entries(propValue as Record<string, string>).forEach(([key, value]) => {
...
export function getResponsiveCSS(parsedProps: any, getCSS: (p: any, b?: boolean) => any) {
